...
def print_time(threadName,delay):
    ...
    while count < 5:
        time.sleep(delay)
        #number of seconds specified in sleep func is the time program will not do anything
...
while True:
    #this loop do nothing but runs infinitaly 
    pass
    #this loop simply passes and calls function idk how?
