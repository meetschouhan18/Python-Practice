import datetime
print(dir(datetime.date))                     #it provides various functions present inside datetime library
print(datetime.datetime.now())    #prints date and time at this instant
print(datetime.date.today())        #prints today's date
a = 2000
b = 12
c = 18
print(datetime.date(a,b,c))          #prints date - 2020-12-18 #my bday
print(datetime.date.fromtimestamp(1))                   #it will print the date when 1sec has passed from 1-1-1970
...
print(date.fromtimestamp(34534523))                  #it will print the date when 34534523sec has passed from 1-1-1970
tooday = date.today()
print("\t",tooday)
...
a = time()                               #set time to 0:0:0
print(a)
b = time(11,34,36,33244)          #set time to 11:34:36:33244
print(b)
...
#from datetime import datetime,date        #commented since imported above
...
from datetime import timedelta    #timedelta is same as datetime but timedelta can also take weeks
...
#Creating String from time
#from datetime import datetime      #commented since imported above
now = datetime.now()
print(now)
